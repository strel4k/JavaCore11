...
//демонстрация применнеия класса FileOutputStream c традиционным способом закрытия
...
//            f1.write(buf);
//
//            //записать данные в трейтий файл
//            f2.write(buf, buf.length-buf.length/4, buf.length/4);
//
//        } catch(IOException e) {
//            System.out.println("Произошла ошибка ввода-вывода");
...
//                if (f1 != null) f1.close();
//            }catch (IOException e) {
//                System.out.println("Ощибка закрытия файла file2.txt");
//            }
//            try {
//                if (f2 != null) f2.close();
//            }catch (IOException e) {
//                System.out.println("Ощибка закрытия файла file3.txt");
//            }
//        }
    }
}
